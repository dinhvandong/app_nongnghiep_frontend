...
const Sidebar = (props) => {
  ...
  function gotoChatBoxCoffeeVn(){
    navigate('/admin/chatbox_coffeevn');
  }
  function gotoChatBoxCoffeeRobusta(){
    navigate('/admin/chatbox_coffee_robusta');
  }

  function gotoChatBoxCoffeeArabica(){
    navigate('/admin/chatbox_coffee_arabica');
  }

  function gotoChatBoxGoldBtmc(){
    navigate('/admin/chatbox_gold_btmc');
  }

  function gotoChatBoxGoldSjc(){
    navigate('/admin/chatbox_gold_sjc');
  }
      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex flex-col">
          ...
          >
            ...
            <FaLayerGroup className="w-5 h-5 m-3 text-base_color" />
            {
              active == true ? <div className="text-sm">Phòng chat (Coffee Viet Nam) </div> : <div></div>
            }
          </button>
          
          <button
            onClick={() => gotoChatBoxCoffeeRobusta()}
          ...
          >
            <FaLayerGroup className="w-5 h-5 m-3 text-base_color" />
            {
              active == true ? <div className="text-sm ">Phòng chat (Coffee Robusta)</div> : <div></div>
            }
          </button>

          <button
            onClick={() => gotoChatBoxCoffeeArabica()}
          ...
          >
            <FaLayerGroup className="w-5 h-5 m-3 text-base_color" />
            {
              active == true ? <div className="text-sm ">Phòng chat (Coffee Arabica)</div> : <div></div>
            }
          </button>
          <button
            onClick={() => gotoChatBoxGoldBtmc()}
          ...
          >
            <FaLayerGroup className="w-5 h-5 m-3 text-base_color" />
            {
              active == true ? <div className="text-sm ">Giá vàng (BTMC)</div> : <div></div>

            }
          </button>

          <button
            onClick={() => gotoChatBoxGoldSjc()}
          ...
          >
            <FaLayerGroup className="w-5 h-5 m-3 text-base_color" />
            {
              active == true ? <div className="text-sm ">Gía vàng JSC t</div> : <div></div>
