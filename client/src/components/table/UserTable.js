...
const UserTable = () => {
  ...
  return (
    <div className="w-[100%]  flex justify-center flex-col items-center">
      ...
      {/* <input className='w-[250px]' placeholder='Tên tài khoản' />

      <input className='w-[250px]' placeholder='Điểm' />

      <button className='w-[250px] bg-green-500'>Nạp điểm</button> */}
      ...
      >
        {selectedRow && (
          <div>
            ...
            <p>Name: {selectedRow.username}</p>
            <p>Age: {selectedRow.gold}</p>
          </div>
        )}
      </Modal> */}
    </div>
